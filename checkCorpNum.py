...
try:
    ...
    print("type (사업자 과세유형 [None-미확인, 1-일반과세자, 2-면세과세자, 3-간이과세자, 4-비영리법인, 국가기관)] : %s " % corpState.type)
    print("typeDate (과세유형 전환일자) : %s " % corpState.typeDate)
    print("state (휴폐업상태 [None-미확인, 0-등록되지 않은 사업자번호, 1-사업중, 2-폐업, 3-휴업)] : %s " % corpState.state)
